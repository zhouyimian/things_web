    ...
    <script>
        $(document).ready(function(){
            ...
            var editor = new Simditor({
                ...
                textarea: $('#content'),
                //工具条都包含哪些内容
                toolbar:['title', 'bold', 'italic', 'underline', 'strikethrough', 'fontScale', 'color', 'ol', 'ul', 'code', 'table',  'link', 'hr', 'indent', 'outdent', 'alignment'],
                //若需要上传功能，上传的参数设置。
                upload : {
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span8 page-content">
                ...
                <form id="contact-form" class="row" action="<c:url value='/ArticleController/updateArticle.action'/>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="aid" value="${myarticle.aid}" />
                    <div class="span2">
                    ...
                    <div class="span6">
                        <input type="text" name="title" id="title" value="${myarticle.title}">
                    </div>
                    <div class="span2">
                        <label for="content">文章内容</label>
                    </div>
                    <div class="span6">
                        <textarea name="content" id="content" class="required span6" rows="6" title="* Please enter your message">${myarticle.content}</textarea>
                    </div>

                    <div class="span6 offset2 bm30">
                        <input type="submit" name="submit" value="点击修改" class="btn btn-inverse">
