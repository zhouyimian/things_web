...
<div class="content">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <form action="<c:url value='/CategoryController/admin/editcategory.action'/> ">
                类别id：<input type="text" value="${category.cid}" readonly name="cid">
                类别名：<input type="text" value="${category.cname}" name="cname">
                <input type="submit" value="点击修改" onclick="return confirm('确认修改？')">
            </form>
