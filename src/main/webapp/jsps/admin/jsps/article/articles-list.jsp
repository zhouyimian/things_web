                        ...
                        <tr>
                            ...
                            <c:choose>
                                <c:when test="${item.state==0}">
                                    <td>
                                        <a style="color:red;" href="<c:url value='/ArticleController/findArticleByAid.action?aid=${item.aid}'/> ">未审核</a>
                                    </td>
                                </c:when>
                                <c:when test="${item.state==1}">
                                    <td>
                                        <a href="<c:url value='/ArticleController/findArticleByAid.action?aid=${item.aid}'/> ">已审核</a>
                                    </td>
                                </c:when>
                                <c:when test="${item.state==2}">
                                    <td>
                                        <a href="<c:url value='/ArticleController/findArticleByAid.action?aid=${item.aid}'/> ">审核未通过</a>
                                    </td>
                                </c:when>
                            </c:choose>
                        </tr>
            ...
            <div class="pagination">
                <ul>
                    <c:if test="${ArticlepageQuery.currentPage!=1}">
                        <li><a href="<c:url value='/PageQueryController/loadArticlepage.action?ArticlepageQuery=1'/>">首页</a></li>
                        <li><a href="<c:url value='/PageQueryController/loadArticlepage.action?ArticlepageQuery=${ArticlepageQuery.currentPage-1}'/>">上一页</a></li>
                    </c:if>
                    <c:choose>
                    ...
                    <c:forEach var="i" begin="${begin}" end="${end}">
                        <c:choose>
                            <c:when test="${i==ArticlepageQuery.currentPage}">
                                <li><a href="<c:url value='/PageQueryController/loadArticlepage.action?ArticlepageQuery=${i}'/>" style="background: #575bd1" class="btn active">${i}</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="<c:url value='/PageQueryController/loadArticlepage.action?ArticlepageQuery=${i}'/>" class="btn active">${i}</a></li>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                    <c:if test="${end < ArticlepageQuery.totalPage }">
                    ...
                    <li><a href="<c:url value='/PageQueryController/loadArticlepage.action?ArticlepageQuery=${ArticlepageQuery.currentPage+1}'/>">下一页</a></li>
                        <li><a href="<c:url value='/PageQueryController/loadArticlepage.action?ArticlepageQuery=${ArticlepageQuery.totalPage}'/>">尾页</a></li>
                    </c:if>
                </ul>
            </div>
