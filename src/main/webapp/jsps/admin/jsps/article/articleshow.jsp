...
<script>
    function is_submit(method){
        ...
        if(methodname=="确认审核"){
            document.getElementById("submit-form").action="${pageContext.request.contextPath }/ArticleController/changeArticleState.action";
            document.getElementById("state").value="1";
            document.getElementById("aid").value="${article.aid}";
        }
        else{
            document.getElementById("submit-form").action="${pageContext.request.contextPath }/ArticleController/changeArticleState.action";
